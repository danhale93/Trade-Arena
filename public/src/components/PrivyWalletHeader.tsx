...
export const PrivyWalletHeader = () => {
  ...
  const arenaWallet = useMemo(() => {
    ...
    // Isolate Privy embedded wallet specifically (walletClientType === 'privy')
    const embeddedWallet = wallets.find((w) => w.walletClientType === 'privy');
    // Fallback to external wallet or any connected wallet if embedded is not found
    const activeWallet = embeddedWallet || wallets.find((w) => w.walletClientType !== 'privy') || wallets[0] || null;
